...
import { Bell, Menu, User, LogOut, Settings, Video, BadgeCheck, Calendar } from 'lucide-react';
...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({ toggleMobileNav, pageTitle }) => {
  ...
  return (
    <header className="bg-fmv-carbon-darker/90 backdrop-blur-sm text-fmv-silk fixed top-0 left-0 right-0 h-14 sm:h-16 border-b border-fmv-carbon-light/30 z-30 shadow-sm">
      <div className="container mx-auto h-full px-4">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="flex items-center">
            ...
            <div className="md:hidden font-medium text-lg ml-2">
              {pageTitle}
            </div>
          </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="font-light hidden md:inline-block">
                  {userData?.displayName || currentUser?.email || 'Mein Konto'}
                </span>
              </button>
